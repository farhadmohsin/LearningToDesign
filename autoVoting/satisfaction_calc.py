...
def Monotonicity_efficiency(voting_rule, N=100, m=3, profiles=1000):
    # Don't need it now
    return 0

def Neutrality_efficiency(voting_rule, N=100, m=3, profiles=1000):
    # Relevant for tiebreaker, I guess?
    return 0

def Anonymity_efficiency(voting_rule, N=100, m=3, profiles=1000):
    return 0
...
# print("Condorcet efficiency results for m = 4")
# print("STV")
# Condorcet_efficiency(STV_winner, N = 1000)
# print("Plurality")
# Condorcet_efficiency(plurality_winner)
# print("Borda")
# Condorcet_efficiency(Borda_winner)
# print("2-approval")
# Condorcet_efficiency(two_approv_winner)

# print("veto")
# Condorcet_efficiency(veto_winner)
...
#         if(exist):
#             cnt += 1
#             pl_winner, _ = plurality_winner(votes)
#             bo_winner, _ = Borda_winner(votes)
            
#             if(winner[0] in pl_winner):
#                 cnt_pl += 1
#             if(winner[0] in bo_winner):
#                 cnt_bo += 1
#     print("m = %d"%m)
#     print(cnt, profiles)
#     print(cnt_pl, cnt_bo)
